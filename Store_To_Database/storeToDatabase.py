'''
Make new database at freemysqlhosting.net and update username,password,databasename,etc in the inputDetails.txt
provided attached.
Current account has expired.
'''
...
def createTable(satelliteid,tableName,datafile,host,databaseName,userName,Password=None):
    ...
    cursor.execute("select * from Satellite2")
    l=cursor.fetchall()
    print(l)
