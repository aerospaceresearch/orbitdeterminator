...
for j in range (0,nobs-2):
    ...
    print('j = ', j)
    r1, r2, r3, v2, R, rho1, rho2, rho3, rho_1_, rho_2_, rho_3_, Ea_hc_pos = gm.gauss_iterator_mpc(spk_kernel, mpc_object_data, mpc_observatories_data, inds_, refiters=5, r2_root_ind=r2_root_ind_vec[j])
