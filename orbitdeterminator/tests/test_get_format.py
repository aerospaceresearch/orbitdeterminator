...
TEST_FILE = os.path.dirname(os.path.realpath(__file__)) + "/../obs_data/SourceTXT/"
...
def test_get_format():
	...
	assert gf.get_format(os.path.dirname(os.path.realpath(__file__)) + "/../obs_data/SourceCSV/orbit.csv") == "Cartesian"